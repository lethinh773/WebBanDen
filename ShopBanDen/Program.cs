...
builder.Services.AddTransient<IUserBusiness, UserBusiness>();
builder.Services.AddTransient<IDenRepository, DenRepository>();
builder.Services.AddTransient<IDenBusiness, DenBusiness>();
builder.Services.AddTransient<ILoaiDenRepository, LoaiDenRepository>();
builder.Services.AddTransient<ILoaiDenBusiness, LoaiDenBusiness>();
